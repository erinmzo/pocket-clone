    ...
    <div className="py-[100px] bg-[#fafafa]">
      <Container>
        <div className="w-full text-center">
          ...
          <ul className="mt-[80px] grid grid-cols-2 md:grid-cols-3 gap-10">
            <li className="border border-gray-200 rounded-xl text-left py-8 px-8">
              ...
              <h4 className="mt-4 font-bold">Build a balanced portfolio</h4>
            ...
            <li className="border border-gray-200 rounded-xl text-left py-8 px-8">
              ...
              <h4 className="mt-4 font-bold">Trade in real-time</h4>
              <p className="mt-4 text-gray-700">Get insider tips on big stock moves and act on them within seconds.</p>
            </li>
            <li className="border border-gray-200 rounded-xl text-left py-8 px-8">
              <svg viewBox="0 0 32 32" aria-hidden="true" className="h-8 w-8">
                <circle cx="16" cy="16" r="16" fill="#A3A3A3" fillOpacity="0.2"></circle>
              ...
              <h4 className="mt-4 font-bold">Profit from your network</h4>
              <p className="mt-4 text-gray-700">
            ...
            <li className="border border-gray-200 rounded-xl text-left py-8 px-8">
              ...
              <h4 className="mt-4 font-bold">Encrypted and anonymized</h4>
              <p className="mt-4 text-gray-700">
            ...
            <li className="border border-gray-200 rounded-xl text-left py-8 px-8">
              ...
              <h4 className="mt-4 font-bold">Invest any amount</h4>
              <p className="mt-4 text-gray-700">
            ...
            <li className="border border-gray-200 rounded-xl text-left py-8 px-8">
              ...
              <h4 className="mt-4 font-bold">Portfolio tracking</h4>
              <p className="mt-4 text-gray-700">
